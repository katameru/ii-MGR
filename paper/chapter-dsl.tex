...
This applies not only to simple infox or postfix operators, but also expressions that mimick array access or assignement, where \texttt{a[b] = c} becomes \texttt{a.putAt(b, c)}.
