...
\polishabstract {Języki dziedzinowe to języki wyspecjalizowane dla konkretnej dziedziny.
 W tej pracy badamy wzorce, które mogą być użyte przy projektowaniu DSLa aby lepiej spełniał on swoje cele.
 Przyglądamy się też aspektom języka Scala, które mogą być użyte przy implementacji tych wzorców.}
...
\englishabstract{Domain-specific languages are languages specialized for a specific domain.
 In this paper we explore patterns that a DSL can incorporate into its design to achieve its goals.
